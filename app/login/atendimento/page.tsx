...
/**
 * Entrada de login dedicada ao pessoal de caixa/atendimento (redirecciona para /atendimento apos sessao valida).
 */
export default function LoginAtendimentoPage() {
  return (
    <div className="relative flex min-h-[calc(100dvh-5rem)] flex-col">
      <main className="relative mx-auto flex min-h-[calc(100dvh-5rem)] w-full max-w-6xl flex-col items-center justify-center px-4 py-10 md:py-14">
        ...
        <Suspense fallback={null}>
          <LoginForm variant="staff" defaultNext="/atendimento" />
        </Suspense>
      </main>
    </div>
  );
